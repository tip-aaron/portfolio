...
const { filterOutDrafts = false, filterOutFuturePosts = false, sortByDate = true, limit } = options;
  ...
  if (sortByDate) {
    filteredPosts.sort((a, b) => b.data.publishedOn.getTime() - a.data.publishedOn.getTime())
  } else {
